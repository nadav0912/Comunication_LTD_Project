...
// HMAC-SHA256 is FAST and therefore weak against an offline brute force of a stolen database — bcrypt/scrypt/Argon2 are the
// correct production choice. The brief mandates HMAC, so that is what ships; the report explains why.
// the reset token is SHA-1 and the emailed value equals the stored value.
